...
public class ProducerService {
    ...
    public void create(ProducerCreatedRequest request) {
        ...
        logger.info(Strings.format(
            "created message, id = {}, desc = {}, createdTime = {}", createdMessage.id, createdMessage.desc, createdMessage.createdTime));
        ...
        logger.info(Strings.format(
            "updated message, id = {}, desc = {}, createdTime = {}", updatedMessage.id, updatedMessage.desc, updatedMessage.updatedTime));
